...
This means either that the AGV is already standing on the node, or that the AGV is in the node's deviation range. As such, the first node will not be reported in the `nodeStates`.
