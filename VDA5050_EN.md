...
Line-Guided mobile robots | Mobile robots that follow a predefined trajectories either sent by fleet control or defined on the robot explicitly or implicitly as the direct connection between the nodes.
